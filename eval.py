...
parser.add_argument(
    "--trained_model",
    default="weights_voc_code/120000combined_id_2_pl_threshold_0.99_labeled_set_3011_.pth",
    type=str,
...
parser.add_argument(
    "--voc_root",
    default="/kaggle/working/AL-SSL/data/VOCdevkit",
...
if __name__ == "__main__":
    ...
    folder_path = "/kaggle/working/al_ssl/"
